...
class SearchController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $products = Product::query()
            ->with(['category.game'])       // game берём через основную категорию
            ...
            // чуть лучшая релевантность: точное начало > где-то в середине > остальное
            ->orderByRaw(
        ...
        $out = $products->map(function (Product $p) {
            ...
            return [
                ...
                'stored_image'   => $p->image_url,          // твой аксессор в модели Product
                'url_code'       => $p->slug,               // fallback для старого роутинга
                ...
                // + слaги для текущего маршрута вида /games/{game}/{category}/{product}
                'product_slug'   => $p->slug,
